...
m = Map("mywebserver", translate("Log Overview"), translate("Log overview test"))
--m:chain("mywebserver")
m.pageaction = false

--f = Form("mywebserver", translate("Log view"), translate("This list gives an overview over currently log web server and their status."))
--f.reset = false
--f.submit = false
